   ...
   let stateswitch = false;
    client.on("ready", () => {
        setInterval(() => {
            ...
            if (stateswitch) client.user.setActivity(`${config.prefix}help | Site Soon`, { type: "PLAYING" });
            else client.user.setActivity(`${client.guilds.cache.reduce((c, g) => c + g.memberCount, 0)} User | ${client.guilds.cache.size} Servers`, { type: "PLAYING" });
        }, 5000); //5 second delay
