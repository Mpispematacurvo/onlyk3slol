...
//client.api.applications(client.user.id).guilds('guild id').commands.post({data: {     für einen server VVVV ist für mehr als 1 server
	...
	.setDescription(`[INVITE ME NOW, thanks](https://discord.com/api/oauth2/authorize?client_id=871043192957599755&permissions=8&scope=bot%20applications.commands)
           ...
           |   [\`Website\`](https://notready.no/)   |   :heart: Thanks for inviting!`)
	...
	let totalMembers = client.guilds.cache.reduce((c, g) => c + g.memberCount, 0);
            ...
            const infoembed = new Discord.MessageEmbed()
                .setAuthor(
                    ...
                    client.user.displayAvatarURL(), "https://discord.com/api/oauth2/authorize?client_id=871043192957599755&permissions=8&scope=bot%20applications.commands"
                )
                .setColor(config.colors.yes)
                .addFields(
                    {
            ...
            `)
                .addField("***SUPPORT:***", `
            >>> [\`Server\`](https://discord.gg/JtHCfTMem2) | [\`Invite\`](https://discord.com/api/oauth2/authorize?client_id=871043192957599755&permissions=8&scope=bot%20applications.commands)
            `)
            ...
            .setTitle(`Help Menu\nPrefix: \`${prefix}\``)
                ...
                *more coming soon*
                ...
                `)
                .addField("\u200b","\u200b")
                .addField("**__Idk | Kary :__**", `
                >>> Kary\`  [\`INVITE\`](https://discord.com/api/oauth2/authorize?client_id=789845410998779904&permissions=8&scope=bot%20applications.commands)
                `)
