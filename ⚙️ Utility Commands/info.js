  ...
  run: async (client, message, args) => {
    ...
    const embed = new Discord.MessageEmbed()
        .setAuthor(
            ...
            config.AVATARURL, "https://discord.com/api/oauth2/authorize?client_id=871043192957599755&permissions=8&scope=bot%20applications.commands"
        )
    ...
    .addField("***Kary***", `
    >>> Ok?\``) .addField("***SUPPORT:***", `
    >>> [\`Server\`](https://discord.gg/) | [\`Invite\`](https://discord.com/api/oauth2/authorize?client_id=871043192957599755&permissions=8&scope=bot%20applications.commands)
