  ...
  run: async (client, message, args) => {
              ...
              if(client.settings.get(message.guild.id, `djroles`).toString()!==""){
                ...
                let leftb = "";
                    ...
                    if(!isdj && !message.member.hasPermission("ADMINISTRATOR")) return functions.embedbuilder(client, 6000, message, "#ff264a", "DJ-ROLE", ` You don\'t have permission for this Command! You need to have: ${leftb}`)
                }
                //CHECK IF DJ LOL
