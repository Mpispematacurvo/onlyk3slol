...
async function getAll(client, message) {
    const embed = new MessageEmbed()
        ...
        .addField("**__Kary:__**", `
        >>> [\`INVITE\`](https://discord.com/api/oauth2/authorize?client_id=871043192957599755&permissions=8&scope=bot%20applications.commands)
        `)
            .addField("**__Music - Supported sources__**", `
        >>> \`Youtube\`, \`Spotify\`, \`Soundcloud\`, [\`More\`](https://rows.ga/), ...
        `)
